...
<section class="create_edit_book">
    ...
    <div class="container">
        <figure>
            <img src=<?= Utils::filepath($book ? $book->getFilename() : null) ?> alt=<?= ($book && $book->getFilename(
                )) ? "Couverture du livre" : "Pas d'illustration" ?>>
            <figcaption>
